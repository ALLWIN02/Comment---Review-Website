...
<head>
    ...
    <title>Most Reviewed Businesses</title>
...
<div class="container mt-5">
    ...
    <div class="row">
        ...
        $query = "SELECT businesses.id, businesses.name, businesses.brand_name, businesses.image_url, businesses.description, 
        ...
        if ($result->num_rows > 0) {
            ...
            echo '<div class="alert alert-warning">No businesses found.</div>';
            echo '</div>';
        }
